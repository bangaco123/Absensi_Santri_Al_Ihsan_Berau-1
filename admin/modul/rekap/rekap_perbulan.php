					...
					<table width="100%">
						<tr>
							...
							<td>
								...
								<hr>
								<em>
									JL. P. Hidayatullah, RT.22, Tanjung Redep, Tj. Redeb, Kec. Tj. Redeb, Kabupaten Berau,<br> Kalimantan Timur 77315 <br>
									<b>Telp.(0554) 22176</b>
								</em>
							</td>
							<td>
					...
					<div class="alert alert-warning alert-dismissible mt-2" role="alert">
						...
						<!-- <table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
							<tr>
								...
								<td colspan="<?= $tglTerakhir; ?>" style="padding: 8px;">PERTEMUAN BULAN : <b style="text-transform: uppercase;"><?php echo 'namaBulan'($bulan); ?> <?= date('Y', ($tglBulan)); ?></b></td>
								...
								<tr bgcolor="<?= $warna; ?>">
									...
									?>
										<td align="center" bgcolor="white">
											<?php
											$ket = mysqli_query($con, "SELECT * FROM _logabsensi WHERE DAY(tgl_absen)='$i' AND id_santri='$d[id_santri]' AND id_mengajar='$_GET[pelajaran]' AND MONTH(tgl_absen)='$bulan' GROUP BY DAY(tgl_absen) ");
											foreach ($ket as $h)
									...
									<td align="center" style="font-weight: bold;">
										<?php
										$sakit = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(ket) AS sakit FROM _logabsensi WHERE id_santri='$d[id_santri]' and ket='S' and MONTH(tgl_absen)='$bulan' and id_mengajar='$_GET[pelajaran]' "));
										echo $sakit['sakit'];
									...
									<td align="center" style="font-weight: bold;">
										<?php
										$izin = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(ket) AS izin FROM _logabsensi WHERE id_santri='$d[id_santri]' and ket='I' and MONTH(tgl_absen)='$bulan' and id_mengajar='$_GET[pelajaran]' "));
										echo $izin['izin'];
									...
									<td align="center" style="font-weight: bold;">
										<?php
										$alfa = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(ket) AS alfa FROM _logabsensi WHERE id_santri='$d[id_santri]' and ket='A' and MONTH(tgl_absen)='$bulan' and id_mengajar='$_GET[pelajaran]' "));
										echo $alfa['alfa'];
									...
									<td align="center" style="font-weight: bold;">
										<?php
										$hadir = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(ket) AS hadir FROM _logabsensi WHERE id_santri='$d[id_santri]' and ket='H' and MONTH(tgl_absen)='$bulan' and id_mengajar='$_GET[pelajaran]' "));
										echo $hadir['hadir'];
