...
--
-- Host: localhost:3306
-- Waktu pembuatan: 27 Bulan Mei 2022 pada 07.19
-- Versi server: 5.7.33
-- Versi PHP: 7.4.19
...
(9, '002', 'salim', 'salim', '6fc978af728d43c59faa400d5f6e0471ac850d4c', 'undraw_profile.svg', 'Y');
...
(12, 'KH-21-22', 'Sabtu', '10.00-10.30', '1', 9, 9, 8, 4, 8);
...
--
ALTER TABLE `tb_mkelas`
  MODIFY `id_mkelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
